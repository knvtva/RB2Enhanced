...
*/
#ifdef RB2E_XBOX // Rock Band 2 Xbox 360
...
#define RB2E_PRINT DbgPrint

#endif // RB2E_XBOX

#ifdef RB2E_WII // Rock Band 2 Wii
...
// define logging functions
#define RB2E_PRINT printf

#endif // RB2E_WII

#define RB2E_MSG(x, ...) RB2E_PRINT("[RB2E:MSG] " x "\n", __VA_ARGS__)
#ifdef RB2EDEBUG
#define RB2E_DEBUG(x, ...) RB2E_PRINT("[RB2E:DBG] " x "\n", __VA_ARGS__)
#else
#define RB2E_DEBUG(x, ...)
#endif // RB2EDEBUG
