...
void InitGlobalSymbols()
{
    ...
    {
        RB2E_DEBUG("Global symbols already initialised", NULL);
        return;
    }

    RB2E_DEBUG("Initialising global symbols", NULL);

    memset(&globalSymbols, 0, sizeof(globalSymbols));

    SymbolConstruct(&globalSymbols.print_debug, "print_debug");
    SymbolConstruct(&globalSymbols.rb2e_change_music_speed, "rb2e_change_music_speed");
    SymbolConstruct(&globalSymbols.rb2e_change_track_speed, "rb2e_change_track_speed");
    SymbolConstruct(&globalSymbols.rb2e_get_music_speed, "rb2e_get_music_speed");
    SymbolConstruct(&globalSymbols.rb2e_get_track_speed, "rb2e_get_track_speed");
    SymbolConstruct(&globalSymbols.rb2e_set_venue, "rb2e_set_venue");
    SymbolConstruct(&globalSymbols.rb2e_is_emulator, "rb2e_is_emulator");
    SymbolConstruct(&globalSymbols.rb2e_relaunch_game, "rb2e_relaunch_game");
    SymbolConstruct(&globalSymbols.rb2e_get_song_count, "rb2e_get_song_count");
    SymbolConstruct(&globalSymbols.rb2e_send_event_string, "rb2e_send_event_string");
